    ...
    fields: [{
      ...
      inputs: [{
        ...
        items: [{
          ...
          value: 'maxivision',
          label: 'Максимальный обзор "Maxi-Vision"'
        }, {
          value: 'polltex',
          label: 'Антипыльца "Poll-Tex"'
        }, {
          ...
          value: 'antibird',
          label: 'Алюминиевая/Антиптица'
        }, {
          value: 'diamondsteel',
          label: 'Стальное "Diamond steel"'
        }]
      }, {
        key: 'canvas_color',
        type: 'canvas_color',
  ...
  form: {
    ...
    fields: [{
      ...
      items: [{
        ...
        value: 'petli-metallicheskie',
        label: 'Металлические петли'
      }, {
        value: 'petli-s-dovodchikom',
        label: 'Петли с доводчиком 2 шт'
      }]
    }, {
      key: 'montage',
      type: 'select',
...
var Price = exports.default = /*#__PURE__*/function () {
  ...
  return _createClass(Price, [{
    ...
    value: function calcRailPrice() {
      var price = 0;
      var priceM = 290; // Цена за погонный метр рельсы, р.
...
var Order = /*#__PURE__*/function () {
  function Order(user) {
    ...
    if (!_order.default[_classPrivateFieldGet(_userRole, this)]) throw Error("Order[PriceData] get userdata error ".concat(_classPrivateFieldGet(_userRole, this)));
    _classPrivateFieldSet(_priceData, this, _order.default[_classPrivateFieldGet(_userRole, this)]);
    this.setDefaults();
  }
  ...
  return _createClass(Order, [{
    ...
    function calcRAL() {
      var total = 0;
      if (this.ral === true) {
        var data = _classPrivateFieldGet(_priceData, this).ral;
    ...
    key: "calcSpecialDelivecry",
    value: function calcSpecialDelivecry() {
    ...
    value: function calcTotalPrice() {
      ...
      var specialDeliveryCost = this.calcSpecialDelivecry();
...
},{"../Cart/CartExtras.js":"src/module/Cart/CartExtras.js","../Cart/CartProducts.js":"src/module/Cart/CartProducts.js","../../data/order.js":"src/data/order.js","../../user/User.js":"src/user/User.js"}],"src/module/Product/products/Ramochnaya25.js":[function(require,module,exports) {
"use strict";
...
},{"../ProductForm.js":"src/module/Product/ProductForm.js"}],"src/module/Product/products/PlisseItaly.js":[function(require,module,exports) {
"use strict";
...
function _inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && _setPrototypeOf(t, e); }
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
var PlisseItaly = exports.default = /*#__PURE__*/function (_ProductForm) {
  function PlisseItaly() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, PlisseItaly);
    return _callSuper(this, PlisseItaly, [config]);
  }

  /* Функции для изменения полей (зависимости/поведение/события и т.д) */

  // Изменение максимальной ширины в зависимости от типа открывания
  _inherits(PlisseItaly, _ProductForm);
  return _createClass(PlisseItaly, [{
    key: "opening",
...
var _PlisseItaly = _interopRequireDefault(require("./products/PlisseItaly.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
...
var ProductKeys = {
  ...
  'PlisseItaly': _PlisseItaly.default
};
...
function createOrderItem(form) {
  ...
  // KPI Монтажника
  var kpiInstaller = new _KPIInstaller.default(productKey, formData, productPrice).calculate();
  // KPI Сборщика
...
},{"../../user/User.js":"src/user/User.js","../../data/products.js":"src/data/products.js","../../components/form/FieldGroup.js":"src/components/form/FieldGroup.js","../../components/form/Select.js":"src/components/form/Select.js","../../components/buttons/Button.js":"src/components/buttons/Button.js","../../components/form/InputQuantity.js":"src/components/form/InputQuantity.js","./ProductForm.js":"src/module/Product/ProductForm.js","./ProductPrice.js":"src/module/Product/ProductPrice.js","./ProductSawing.js":"src/module/Product/ProductSawing.js","./kpi/KPIInstaller.js":"src/module/Product/kpi/KPIInstaller.js","./kpi/KPIAssembler.js":"src/module/Product/kpi/KPIAssembler.js","../../dto/DTOProduct.js":"src/dto/DTOProduct.js","../Order/Order.js":"src/module/Order/Order.js","./products/Ramochnaya25.js":"src/module/Product/products/Ramochnaya25.js","./products/RamochnayaOptima.js":"src/module/Product/products/RamochnayaOptima.js","./products/RulonnayaItalia.js":"src/module/Product/products/RulonnayaItalia.js","./products/PlisseItaly.js":"src/module/Product/products/PlisseItaly.js"}],"src/module/Extras/ExtrasSearch.js":[function(require,module,exports) {
"use strict";
